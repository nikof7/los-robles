...
function Header() {
    ...
    return (
        <header className="sticky top-0 start-0 z-50 flex justify-between items-center text-black py-3 px-8 md:px-32 backdrop-blur-lg bg-white/70 shadow-[0px_4px_6px_rgba(0,0,0,0.1)]">
